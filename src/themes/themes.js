export const COLORS = {
  ...
  legacyBridgeSecondBlue: "#B4BED1",

  dashboardWithdrawBgColor: "#f5f8fe",
  dashboardWithdrawTextColor: "#4378ee",
  dashboardBalanceTextColor: "#53a948",
  dashboardBalanceBgColor: "#f7fbf7",
  dashboardSalesBgColor: "#f7f6fe",
  dashboardSalesTextColor: "#653acf",
